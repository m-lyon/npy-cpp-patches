...
class TestPatcherTuple(BaseTestCases.BaseTest, ExtraTestMixin):
    '''Patch shape larger than data shape'''


class TestPatcherList(BaseTestCases.BaseTest, ExtraTestMixin):
    assert_type = list


class TestPatcherNumpyArray(BaseTestCases.BaseTest, ExtraTestMixin):
    assert_type = np.array
